...
@testset "single- and multi-channel in-memory reconstruction" begin
  ...
  exportImage("$imgdir/Reconstruction1.png", arraydata(c1[1,:,:,1,1]))
  ...
  exportImage("$imgdir/Reconstruction2.png", arraydata(c2[1,:,:,1,1]))
  ...
  exportImage("$imgdir/Reconstruction3.png", arraydata(c3[1,:,:,1,1]))
  ...
  exportImage("$imgdir/Reconstruction4.png", arraydata(c4[1,:,:,1,1]))
  ...
  exportImage("$imgdir/Reconstruction5a.png", arraydata(c5[1,:,:,1,1]))
  exportImage("$imgdir/Reconstruction5b.png", arraydata(c5[2,:,:,1,1]))
  ...
  @test axisnames(c5) == names
  @test axisvalues(c5) == (1:2,values[2:end]...)
  exportImage("$imgdir/Reconstruction5c.png", arraydata(c5[1,:,:,1,1]))
  exportImage("$imgdir/Reconstruction5d.png", arraydata(c5[2,:,:,1,1]))
  ...
  exportImage("$imgdir/Reconstruction6.png", arraydata(c6[1,:,:,1,1]))
