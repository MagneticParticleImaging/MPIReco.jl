...
@testset "sparse single- and multi-channel in-memory reconstruction" begin
  ...
  exportImage("./img/Sparse1.png", arraydata(data(c1[1,:,:,1,1])))
  ...
  exportImage("./img/Sparse2.png", arraydata(data(c2[1,:,:,1,1])))
  ...
  exportImage("./img/Sparse3.png", arraydata(data(c3[1,:,:,1,1])))
  ...
  exportImage("./img/Sparse4.png", arraydata(data(c4[1,:,:,1,1])))
  ...
  exportImage("./img/Sparse5.png", arraydata(data(c5[1,:,:,1,1])))
  ...
  exportImage("./img/Sparse6.png", arraydata(data(c6[1,:,:,1,1])))
  ...
  exportImage("./img/Sparse7.png", arraydata(data(c7[1,:,:,1,1])))
end
