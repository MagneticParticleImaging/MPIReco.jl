...
@testset "multi-gradient in-memory reconstruction" begin
  ...
  b = MultiMPIFile([joinpath(datadir, "MG_G1"), joinpath(datadir, "MG_G2_03")])
  bSFs = MultiMPIFile([joinpath(datadir, "SF_MG_G1"), joinpath(datadir, "SF_MG_G2")])
  ...
  dirs = ["MG_G1", "MG_G2_01", "MG_G2_02", "MG_G2_03"]
  ...
  # low gradient only
  b = MultiMPIFile([joinpath(datadir, "MG_G1")])
  bSFs = MultiMPIFile([joinpath(datadir, "SF_MG_G1")])
